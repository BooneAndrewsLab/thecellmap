...
from base.models import Strain, Region, RegionGroup, Vertex, Dataset, Term
from base.utils import CellMapCommand, open_excel_file
...
class Command(CellMapCommand):
    ...
    option_list = CellMapCommand.option_list + (
        make_option('-a', '--alias',
                    dest='r_group_alias',
    ...
    def handle(self, *args, **options):
        ...
        for region, strains in regions.items():
