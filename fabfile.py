"""
Starter fabfile for deploying the thecellmap project.
...
# CHANGEME
env.hosts = ['user@thecellmap.example.com']
env.code_dir = '/srv/www/thecellmap'
env.project_dir = '/srv/www/thecellmap/thecellmap'
env.static_root = '/srv/www/thecellmap/static/'
env.virtualenv = '/srv/www/thecellmap/.virtualenv'
env.code_repo = 'git@github.com:user/thecellmap.git'
env.django_settings_module = 'thecellmap.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/thecellmap/wsgi.py" % env.code_dir)
