...
//                    console.log('change');
                    ...
                    sigInst.iterNodes(function(node) {
                        ...
                        if (!state.get('manualSelection') && node.degree == 0) return; // do not select standalone nodes
                    ...
                    _.each(diff, function(n) {
                        ...
                        if (!node || (!state.get('manualSelection') && node.degree == 0)) { // if it's a standalone node, add it to missing nodes list
